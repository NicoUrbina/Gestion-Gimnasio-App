    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6">
            <div>
                ...
                <p className="text-gray-400 mt-1">Complete los datos del equipo</p>
            </div>

            <form onSubmit={handleSubmit} className="bg-zinc-900 rounded-xl border border-zinc-800 p-8 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 border border-zinc-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
                        />
                    </div>
                    <div>
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-gray-300 mb-2">Número de Serie</label>
                        <input
                            type="text"
                            name="serial_number"
                ...
                <div className="flex gap-4">
                    ...
                    <button
                        ...
                        className="px-6 py-3 bg-slate-200 text-gray-300 font-bold rounded-lg hover:bg-slate-300 transition"
                    >
                        Cancelar
                    </button>
                </div>
